...
<head>
  ...
  <title>MONTHLY CERTIFICATION ON APPROPRIATIONS, FUND AND OBLIGATION OF ALLOTMENT (CAFOA)</title>
<?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <h1>MONTHLY CERTIFICATION ON APPROPRIATIONS, FUND AND OBLIGATION OF ALLOTMENT (CAFOA) REPORT</h1>
