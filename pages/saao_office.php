  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <h1>STATUS OF APPROPRIATIONS, ALLOTMENT AND OBLIGATION-OFFICES</h1>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text text-light" style="background-color:#004d00;"><b>OFFICES:</b></div>
                                    </div>
                                        ...
                                        <datalist class="function_list" id="function_list">
                                            <?php 
                                                $select_query1 = mysqli_query($connection,"SELECT * from tbl_function WHERE type='OFFICE' ORDER BY function_code ASC");
