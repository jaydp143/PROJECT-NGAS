       ...
       <!-- /.div for FORM -->
            ...
            <div class="col-12">
                <div class='card'>
                    <div class='card-header d-flex  justify-content-between align-items-center' style="background-color:#004d00;">
                        <h6 class='m-0 font-weight-bold text-light'><i class="fas fa-list"></i>&emsp;<?php echo $_POST['rp_type'].'S ALLOTMENT FOR BUDGET YEAR  '. $_POST['rp_year']  ?></h6>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="dataTables-example" class="table table-striped table-bordered table-sm " style="text-align:center; width:100%">
                            ...
                            <?php
                                ...
                                (SELECT COALESCE(SUM(al.amount_appropriation), 0) FROM tbl_appropriation as al WHERE al.function_code=fc.function_code AND al.budget_year='".$_POST['rp_year']."'GROUP BY al.function_code) AS appropriation,
                                (SELECT COALESCE(SUM(al.first_qtr), 0) FROM tbl_allotment as al WHERE al.function_code=fc.function_code AND al.budget_year='".$_POST['rp_year']."'GROUP BY al.function_code) AS first,
                                (SELECT COALESCE(SUM(al.second_qtr), 0) FROM tbl_allotment as al WHERE al.function_code=fc.function_code AND al.budget_year='".$_POST['rp_year']."'GROUP BY al.function_code) AS second, 
                                (SELECT COALESCE(SUM(al.third_qtr), 0) FROM tbl_allotment as al WHERE al.function_code=fc.function_code AND al.budget_year='".$_POST['rp_year']."'GROUP BY al.function_code) AS third,
                                (SELECT COALESCE(SUM(al.fourth_qtr), 0) FROM tbl_allotment as al WHERE al.function_code=fc.function_code AND al.budget_year='".$_POST['rp_year']."'GROUP BY al.function_code) AS fourth,
                                (SELECT COALESCE(SUM(al.total_allotment), 0) FROM tbl_allotment as al WHERE al.function_code=fc.function_code AND al.budget_year='".$_POST['rp_year']."'GROUP BY al.function_code) AS total_allotment
                            ...
                            <tr>       
                                ...
                                <td align="center"><a href="<?php echo $location.'.php?id='.$row["function_id"].'&&yr='.$_POST['rp_year'].'&&type='.$_POST['rp_type']; ?>" class="btn btn-danger btn-sm  <?php //echo $bg; ?>"><i class="fas fa-info"></i> VIEW DETAILS</a></td>
                            </tr>
        ...
        <div class="row">
            <div class="col-12">
                <div class='card'>
                    <div class='card-header d-flex  justify-content-between align-items-center' style="background-color:#004d00;">
                        <h6 class='m-0 font-weight-bold text-light'><i class="fas fa-list"></i> &emsp;<?php echo 'OFFICES ALLOTMENT FOR BUDGET YEAR  '. $curYear;  ?></h6>
                    </div>
                <div class='card-body shadow'>
                    <div class="table-responsive">
                        <table id="dataTables-example" class="table table-striped table-bordered table-sm " style="text-align:center; width:100%">
                            ...
                            <tr>       
                                ...
                                <td align="center"><?php echo $fourth; ?></td>
                                <td align="center"><?php echo $allot; ?></td>
                                <td align="center"><a href="<?php echo 'allotment_details.php?id='.$row["function_id"].'&&yr='.$curYear.'&&type=OFFICE'; ?>" class="btn btn-danger btn-sm <?php //echo $bg; ?>"><i class="fas fa-info"></i> VIEW DETAILS</a></td>
                            </tr>
