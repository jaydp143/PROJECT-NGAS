                    ...
                    <div class="table-responsive">
                        <table id="dataTables-example" class="table table-striped table-bordered table-sm " style="text-align:center; width:100%">
                            ...
                            <tr>       
                                ...
                                <td align="center"><a href="<?php echo 'allotment_details.php?id='.$row["function_id"].'&&yr='.$curYear.'&&type=NON-OFFICE'; ?>" class="btn btn-danger btn-sm <?php //echo $bg; ?>"><i class="fas fa-info"></i> VIEW DETAILS</a></td>
                            </tr>
