<nav class="main-header navbar navbar-expand-md navbar-success navbar-light" style="background-color:#03254c;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="#" role="button"><p class="fas fa-bars text-light"></p> </a>
      </li>
    </ul>
    <!-- Right navbar links -->
