  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <h1>STATUS OF APPROPRIATIONS, ALLOTMENT AND OBLIGATION-NON-OFFICES</h1>
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text text-light" style="background-color:#004d00;"><b>PROJECTS/PROGRAMS:</b></div>
                                    </div>
                                        ...
                                        <datalist class="function_list" id="function_list">
                                            <?php 
                                                $select_query1 = mysqli_query($connection,"SELECT * from tbl_function WHERE type='NON-OFFICE'");
                ...
                <div class='card'>
                    <div class="card-header text-primary " style="background-color:#004d00;">
                        ...
                        <div class="card-tools">
                            <form method='POST' action='../report/report_saao_non_office.php' target="_blank">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        if($_POST['rp_function']=="ALL"){
                                            ...
                                            FROM tbl_function as f WHERE f.type='NON-OFFICE'"; 
                                        }
                                        else{
                                            $query="SELECT f.description, f.type,
                                            (SELECT COALESCE(SUM(app.amount_appropriation), 0)  FROM tbl_appropriation as app INNER JOIN tbl_accounts as acc ON app.account_code = acc.account_code WHERE app.function_code=f.function_code AND app.budget_year='".$curYear."' AND acc.acc_category='PERSONAL SERVICES')AS appropriation_ps, 
                                    ...
                                    <tr align="center"> 
                                        ...
                                        <td><?php echo number_format($row['appropriation_co'],2); ?></td>
                                        <td ><?php echo number_format($row['allotment_co'],2); ?></td>
                                        <td ><?php echo number_format($row['obligation_co'],2); ?></td>
                                        <td><?php echo number_format($bal_allotment_co,2); ?></td>
                                        <td ><?php echo number_format($bal_appropriation_co,2); ?></td>
