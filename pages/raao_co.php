  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <h1>REGISTRY OF APPROPRIATIONS, ALLOTMENTS AND OBLIGATIONS-CAPITAL OUTLAY</h1>
        ...
        <div class='card'>
            <div class="card-header text-primary ">
                ...
                <div class="card-tools">
                    <form method='POST' action='../report/report_raao_co.php' target="_blank">
                        ...
                        <button type='submit' class='btn btn-info btn-block text-light' id='btn_generate' name='btn_generate'><i class='fas fa-print'></i><b> GENERATE RAAOCO REPORT</b></button>
                    </form>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table id="dataTables-example" class="table table-striped table-bordered table-sm ">
                                ...
                                <tbody>
                                    <?php
                                        $query = mysqli_query($connection,"SELECT * FROM tbl_obligation WHERE function='".$_POST['rp_function']."' AND MONTH(trans_date)='".$_POST['rp_month']."' AND YEAR(trans_date)='".$_POST['rp_year']."' AND allotment_class='CO'");
                                        while($row = mysqli_fetch_array($query)){      
                                    ?>
                                    <tr>       
