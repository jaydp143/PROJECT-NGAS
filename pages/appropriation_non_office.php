<?php 
    $pagename="appropriation_non_office";
    require('./session.php'); 
...
<head>
  ...
  <title>APPROPRIATION: NON-OFFICES</title>
<?php
...
<div class="wrapper" >
  ...
  <?php
      ...
      $appropriation_non_office="active";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <h1>APPROPRIATIONS: NON-OFFICES</h1>
                  ...
                  <div class="table-responsive">
                      <table id="dataTables-example" class="table table-striped table-bordered table-sm " style="text-align:center; width:100%">
                          ...
                          <tbody>
                            ...
                            FROM tbl_function as fc WHERE fc.type='NON-OFFICE'");
                            ...
                            <td align="center"><?php //echo number_format($row["CO"],2); ?></td> -->
                              ...
                              <td align="center"><a href="<?php echo 'appropriation_details.php?id='.$row["function_id"].'&&yr='.$curYear.'&&type=NON-OFFICE'; ?>" class="btn btn-sm btn-danger"><i class="fas fa-info"></i> VIEW DETAILS</a></td>
                              <!-- <td align="center">
