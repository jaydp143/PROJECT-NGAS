...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->SetFont('times', 'B', 12);
        $this->Cell($length, 1, ' OBLIGATIONS-PERSONAL SERVICES(PS)', 0, 1, 'C');
...
$querytotal_appropriation="SELECT SUM(app.amount_appropriation) AS amount FROM tbl_appropriation as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='PERSONAL SERVICES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'";
...
$querytotal_allotment="SELECT SUM(app.total_allotment) AS amount FROM tbl_allotment as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='PERSONAL SERVICES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'";
...
$tbl.=' 
    ...
    <tbody>
      ...
      $tbl.='<tr>
        ...
        <td style="text-align:center; width:450px"></td>
        <td style="text-align:center; width:100px"></td>'; 
        $queryallotment="SELECT app.total_allotment, acc.account_code, acc.account_description FROM tbl_allotment as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='PERSONAL SERVICES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'";
...
$query = mysqli_query($connection,"SELECT * FROM tbl_obligation WHERE function='".$_POST['function']."' AND MONTH(trans_date)='".$_POST['month']."' AND YEAR(trans_date)='".$_POST['budget_year']."' AND allotment_class='PS'");
while($row = mysqli_fetch_array($query)){      
...
$tbl.=' 
      <tr>
        ...
        $query_this_month = "SELECT COALESCE(SUM(total), 0) AS amount FROM tbl_obligation WHERE function='".$_POST['function']."' AND MONTH(trans_date)='".$_POST['month']."' AND YEAR(trans_date)='".$_POST['budget_year']."' AND allotment_class='PS'";
        ...
        $query1 = mysqli_query($connection,"SELECT (SELECT COALESCE(SUM(exp.amount), 0) AS amount FROM tbl_expenses as exp WHERE exp.expense_code=app.account_code AND MONTH(exp.trans_date)='".$_POST['month']."'AND YEAR(exp.trans_date)='".$_POST['budget_year']."'AND exp.function='".$_POST['function']."' ) as amount FROM tbl_appropriation as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='PERSONAL SERVICES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'");
        while($row1 = mysqli_fetch_array($query1)){       
...
$tbl.=' </tr>';
      ...
      $tbl.='<tr>
        ...
        <td style="text-align:right; width:450px"><b>Total Last Month:</b></td>';
         $query_last_month = "SELECT COALESCE(SUM(total), 0) AS amount FROM tbl_obligation WHERE function='".$_POST['function']."' AND MONTH(trans_date) BETWEEN '1' AND '".($_POST['month']-1)."' AND YEAR(trans_date)='".$_POST['budget_year']."' AND allotment_class='PS'";
        ...
        $query1 = mysqli_query($connection,"SELECT (SELECT COALESCE(SUM(exp.amount), 0) AS amount FROM tbl_expenses as exp WHERE exp.expense_code=app.account_code AND MONTH(trans_date) BETWEEN '1' AND '".($_POST['month']-1)."' AND YEAR(exp.trans_date)='".$_POST['budget_year']."'AND exp.function='".$_POST['function']."' ) as amount FROM tbl_appropriation as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='PERSONAL SERVICES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'");
        while($row1 = mysqli_fetch_array($query1)){       
          $tbl.='<td style="text-align:right; width:100px">'.number_format($row1['amount'],2).'</td>'; 
        }
$tbl.=' </tr>
      ...
      <tr>
        ...
        $query_total_to_date = "SELECT COALESCE(SUM(total), 0) AS amount FROM tbl_obligation WHERE function='".$_POST['function']."' AND MONTH(trans_date) BETWEEN '1' AND '".$_POST['month']."' AND YEAR(trans_date)='".$_POST['budget_year']."' AND allotment_class='PS'";
        ...
        $query1 = mysqli_query($connection,"SELECT (SELECT COALESCE(SUM(exp.amount), 0) AS amount FROM tbl_expenses as exp WHERE exp.expense_code=app.account_code AND MONTH(trans_date) BETWEEN '1' AND '".$_POST['month']."' AND YEAR(exp.trans_date)='".$_POST['budget_year']."'AND exp.function='".$_POST['function']."' ) as amount FROM tbl_appropriation as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='PERSONAL SERVICES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'");
        while($row1 = mysqli_fetch_array($query1)){       
          $tbl.='<td style="text-align:right; width:100px">'.number_format($row1['amount'],2).'</td>'; 
        }
$tbl.='</tr>
...
(app.amount_appropriation-(SELECT COALESCE(SUM(exp.amount), 0) AS amount FROM tbl_expenses as exp WHERE exp.expense_code=app.account_code AND MONTH(trans_date) BETWEEN '1' AND '11' AND YEAR(exp.trans_date)='".$_POST['budget_year']."'AND exp.function='".$_POST['function']."' )) as balance FROM tbl_appropriation as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='PERSONAL SERVICES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'");
        while($row1 = mysqli_fetch_array($query1)){       
