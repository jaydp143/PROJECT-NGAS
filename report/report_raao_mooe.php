...
$tbl.=' 
      <tr>
        ...
        $query1 = mysqli_query($connection,"SELECT (SELECT amount FROM tbl_expenses as exp WHERE exp.expense_code=app.account_code AND exp.obligation_id='".$row['obligation_id']."') as amount FROM tbl_appropriation as app INNER JOIN tbl_accounts as acc ON app.account_code=acc.account_code WHERE acc.acc_category='MAINTENANCE AND OTHER OPERATING EXPENSES'  AND app.budget_year='".$_POST['budget_year']."' AND app.function_code='".$_POST['function']."'");
